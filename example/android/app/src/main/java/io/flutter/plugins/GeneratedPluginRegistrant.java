...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    try {
      flutterEngine.getPlugins().add(new com.ayeee.blue_print_pos.BluePrintPosPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin blue_print_pos, com.ayeee.blue_print_pos.BluePrintPosPlugin", e);
    }
    try {
